...
import { DEFAULT_TARGET_ROUNDS } from '../types/game';
...
export const RoundCountSelectionModal: React.FC<Props> = ({
  visible,
  title = 'Kaç tur oynayacaksınız?',
  onSelect,
  onCancel,
}) => {
  ...
  const pickClassic = () => {
    ...
    onSelect(DEFAULT_TARGET_ROUNDS);
  };
      ...
      <Pressable style={styles.overlay} onPress={onCancel}>
        <Pressable style={styles.card} onPress={() => {}}>
          ...
          <Text style={styles.subtitle}>
            Son turda otomatik bildirim alırsın
          </Text>
          ...
          >
            <Text style={styles.classicTitle}>KLASİK</Text>
            <Text style={styles.classicSub}>11 tur · standart</Text>
          </Pressable>
